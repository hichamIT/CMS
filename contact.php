                ...
                <h1>Contact</h1>
                    <form role="form" action="" method="post"  autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="subject" id="username" class="form-control" placeholder="Enter Desired Username">
                        </div>
                         <div class="form-group">
                            <label for="body" class="sr-only">Message body</label>
                            <textarea name="body" id="" cols="50" rows="10"  class="form-control"></textarea>
                        </div>
